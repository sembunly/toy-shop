...
@section('title', 'About Us - Toy Shop')

@section('hero_title', 'About Toy Shop')
@section('hero_subtitle', 'Your trusted toy shop in Cambodia')
...
<div class="row g-4">
  ...
  <div class="col-12">
    <div class="border-0 shadow-sm card" style="border-radius: 16px;">
      <div class="p-4 card-body">
        <h2 class="mb-4 fw-bold" style="color: #6e6e73;">Welcome to Toy Shop</h2>
        <p class="mb-4 text-secondary">
          Toy Shop is your trusted destination for toys and games in Cambodia.
          We specialize in providing fun, safe, and high-quality toys for every age.
        </p>
        <p class="mb-4 text-secondary">
  ...
  <div class="col-12">
    <div class="border-0 shadow-sm card" style="border-radius: 16px;">
      <div class="p-4 card-body">
        <h2 class="mb-4 text-center fw-bold" style="color: #6e6e73;">Our Team</h2>
  ...
  <div class="col-12">
    <div class="border-0 shadow-sm card"
        style="border-radius: 16px; background: #6e6e73;">
      <div class="p-4 text-center card-body">
        ...
        <div class="flex-wrap gap-4 d-flex justify-content-center">
          ...
          <div class="text-white">
            <i class="bi bi-telephone me-2"></i>010 800 921
          </div>
          <div class="text-white">
